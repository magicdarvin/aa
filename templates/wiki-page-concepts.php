<?php
/*
	Template name: Wiki Concepts page
*/
get_header('wiki');
?>
	...
	<section class="site-main">
		...
		<div id="main-feed" class="grid spread blocks wiki">
			<div class="mobile">
				...
				<div>
					<label for="city"><a href="<?php echo get_permalink(44924); ?>">Города</a></label>
				</div>
			</div>
			...
			<div id="cities" class="desktop">
				<label for="city"><a href="<?php echo get_permalink(44924); ?>">Города</a></label><br /><span class="fuckthisplus">+</span>
				<?php //echo render_filter_list(3843,'city'); ?>
			</div>
			<div id="concepts" class="fuckingbullshit insane">
				<label for="concept" class="fuckingborders"><a href="<?php echo get_permalink(44927); ?>">Понятия</a></label><input type="text" class="search" name="concept" id="concept" placeholder="|">
