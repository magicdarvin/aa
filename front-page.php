...
<div class="content container grid <?php echo $_GET['city']; echo $_GET['filter']; ?>">
	...
	<section class="site-main the-main">
		...
		<div id="main-feed" class="grid spread blocks <?php if(isset($_GET['filter']) && $_GET['filter'] == 'photos') echo 'photos-filter'; ?>">
		<?php
			$counter = 0;
			if(!$featured && !isset($_GET['city']) && !isset($_GET['filter'])) $counter = 1;
